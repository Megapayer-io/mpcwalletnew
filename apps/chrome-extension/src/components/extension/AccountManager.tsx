...
import { Plus, Download, Trash2, Eye, Copy, Check, AlertCircle } from 'lucide-react';
...
export function AccountManager() {
  ...
  const handleCreateAccount = async () => {
    try {
      clearError();
      createAccount(createData.name || `Account ${accounts.length + 1}`);
      setCreateData({ name: '' });
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          ...
          <button
            ...
            title="Clear corrupted account data"
          >
