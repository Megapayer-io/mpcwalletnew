 ...
 */
export class SimplePinAuthentication {
    config;
    storageKey;
    attemptsKey;
    lockoutKey;
    ...
    async setSecureStorage(key, value) {
        try {
            ...
            // Try Tauri storage (placeholder for future implementation)
            if (typeof window !== 'undefined' && window.__TAURI__) {
                // Tauri implementation would go here
                console.log('Tauri storage not implemented yet');
            }
...
export const simplePinAuthentication = new SimplePinAuthentication();
