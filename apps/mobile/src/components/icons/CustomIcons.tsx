...
export const CustomIcons = {
  ...
  // Buy/Shopping Cart with premium 3D effect
  Buy: ({ className = "w-5 h-5" }: { className?: string }) => (
    <div className={`relative ${className}`}>
      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
        {/* Cart shadow */}
        <path d="M3 3 L5 19 L19 19 L21 7 L7 7" fill="currentColor" opacity="0.1" />
        {/* Main cart */}
        <path d="M3 3 L5 19 L19 19 L21 7 L7 7" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        {/* Cart handle */}
        <path d="M7 7 L3 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        {/* Cart wheels */}
        <circle cx="8" cy="19" r="2" fill="none" stroke="currentColor" strokeWidth="2" />
        <circle cx="18" cy="19" r="2" fill="none" stroke="currentColor" strokeWidth="2" />
        {/* Dollar sign */}
        <path d="M12 9 L12 11" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M12 13 L12 15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M10 12 C10 11 10.5 10.5 11 10.5 C11.5 10.5 12 11 12 12 C12 13 11.5 13.5 11 13.5 C10.5 13.5 10 14 10 15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
        {/* Cart highlight */}
        <path d="M5 5 L19 5 L20 8 L6 8" fill="white" opacity="0.2" />
      </svg>
    </div>
  ),

  // Swap/Exchange with premium 3D effect
  Swap: ({ className = "w-5 h-5" }: { className?: string }) => (
    <div className={`relative ${className}`}>
      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
        {/* Swap shadow */}
        <path d="M7 16 L3 20 L7 24" fill="currentColor" opacity="0.1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M17 8 L21 4 L17 0" fill="currentColor" opacity="0.1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <line x1="3" y1="20" x2="21" y2="4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="0.1" />
        {/* Main swap arrows */}
        <path d="M7 16 L3 20 L7 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M17 8 L21 4 L17 0" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        {/* Center connection line */}
        <line x1="3" y1="20" x2="21" y2="4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        {/* Exchange circles */}
        <circle cx="5" cy="18" r="2" fill="currentColor" opacity="0.3" />
        <circle cx="19" cy="6" r="2" fill="currentColor" opacity="0.3" />
        {/* Highlight */}
        <path d="M7 17 L4 20 L7 23" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" opacity="0.4" />
        <path d="M17 7 L20 4 L17 1" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" opacity="0.4" />
      </svg>
    </div>
  ),

  // Send Arrow - Dashboard version (different from navigation)
  SendArrow: ({ className = "w-5 h-5" }: { className?: string }) => (
    <div className={`relative ${className}`}>
      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
        {/* Arrow shadow */}
        <circle cx="12" cy="12" r="10" fill="currentColor" opacity="0.1" />
        {/* Paper plane */}
        <path d="M3 11 L11 19 L12 12 L21 3 L3 11 Z" fill="currentColor" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
        {/* Arrow highlight */}
        <path d="M4 11 L10 14 L11 12 L4 11 Z" fill="white" opacity="0.3" />
        <path d="M12 12 L18 5 L20 4 L12 12 Z" fill="white" opacity="0.2" />
      </svg>
    </div>
  ),

  // Receive/QR Code - Dashboard version
  ReceiveQR: ({ className = "w-5 h-5" }: { className?: string }) => (
    <div className={`relative ${className}`}>
      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
        {/* QR code shadow */}
        ...
        <rect x="6" y="17" width="1" height="1" fill="white" />
        {/* Center dots */}
        <circle cx="11" cy="11" r="0.5" fill="currentColor" opacity="0.6" />
  ...
  // Buy/Shopping Bag - Dashboard version
  BuyBag: ({ className = "w-5 h-5" }: { className?: string }) => (
    <div className={`relative ${className}`}>
      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
        {/* Bag shadow */}
        <path d="M6 8 L6 20 C6 21 7 22 8 22 L16 22 C17 22 18 21 18 20 L18 8" fill="currentColor" opacity="0.1" />
        {/* Main bag */}
        <path d="M6 8 L6 20 C6 21 7 22 8 22 L16 22 C17 22 18 21 18 20 L18 8" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        {/* Bag handles */}
        <path d="M9 8 L9 4 C9 3 10 2 11 2 L13 2 C14 2 15 3 15 4 L15 8" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        {/* Dollar sign */}
        <circle cx="12" cy="14" r="3" fill="none" stroke="currentColor" strokeWidth="1.5" opacity="0.4" />
        <line x1="12" y1="12" x2="12" y2="13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="12" y1="15" x2="12" y2="16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M10 14 C10 13.5 10.5 13 11 13 C11.5 13 12 13.5 12 14 C12 14.5 11.5 15 11 15 C10.5 15 10 14.5 10 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        {/* Bag highlight */}
        <path d="M7 9 L17 9" stroke="white" strokeWidth="0.5" opacity="0.3" />
      </svg>
    </div>
  ),

  // Swap Arrows - Dashboard version (more decorative)
  SwapArrows: ({ className = "w-5 h-5" }: { className?: string }) => (
    <div className={`relative ${className}`}>
      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
        {/* Double arrow shadow */}
        <path d="M8 16 L4 20 L8 16 L4 12" fill="currentColor" opacity="0.1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M16 8 L20 4 L16 8 L20 12" fill="currentColor" opacity="0.1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        {/* Main double arrows */}
        <path d="M8 16 L4 20 L8 16 L4 12" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M16 8 L20 4 L16 8 L20 12" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        {/* Center connection */}
        <line x1="6" y1="14" x2="18" y2="10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.5" />
        {/* Circle indicators */}
        <circle cx="5" cy="16" r="1.5" fill="currentColor" opacity="0.4" />
