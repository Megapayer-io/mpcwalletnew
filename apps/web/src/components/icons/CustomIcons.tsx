...
export const CustomIcons = {
  ...
  // ArrowLeftRight with 3D effect (P2P Exchange icon)
  ArrowLeftRight: ({ className = "w-5 h-5" }: { className?: string }) => (
    <div className={`relative ${className}`}>
      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
        {/* Arrows shadow */}
        <path d="M8 7 L4 11 L8 15" fill="currentColor" opacity="0.1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M16 17 L20 13 L16 9" fill="currentColor" opacity="0.1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <line x1="4" y1="11" x2="20" y2="11" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity="0.1" />
        {/* Main arrows */}
        <path d="M8 7 L4 11 L8 15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M16 17 L20 13 L16 9" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <line x1="4" y1="11" x2="20" y2="11" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        {/* Arrows highlight */}
        <path d="M7 8 L5 11 L7 14" fill="none" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" opacity="0.3" />
        <path d="M17 16 L19 13 L17 10" fill="none" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" opacity="0.3" />
      </svg>
    </div>
  )
};
